...
namespace Text_Based_RPG
{
    internal class Render
    {
        ...
        public Render(Map map)
        {
            ...
            camBufferPrev = new RenderSpace[Globals.CAMERA_RADIUS * 2, Globals.CAMERA_RADIUS * 2];
            camBufferNext = new RenderSpace[Globals.CAMERA_RADIUS * 2, Globals.CAMERA_RADIUS * 2];
        }
        ...
        public void Draw()
        {
            for (int y = 0; y < camBufferNext.GetLength(0); y++)
            {
                ...
                {
                    camBufferNext[y, x] = wholeMap[y + camera.GetPos()[1] - Globals.CAMERA_RADIUS + 1, x + camera.GetPos()[0] - Globals.CAMERA_RADIUS + 1];
