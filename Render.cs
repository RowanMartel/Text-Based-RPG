...
namespace Text_Based_RPG
{
    internal class Render
    {
        ...
        public Render(Map map)
        {
            ...
            camBufferPrev = new RenderSpace[Constants.CAMERA_RADIUS * 2, Constants.CAMERA_RADIUS * 2];
            camBufferNext = new RenderSpace[Constants.CAMERA_RADIUS * 2, Constants.CAMERA_RADIUS * 2];
        }
        ...
        public void Draw()
        {
            for (int y = 0; y < camBufferNext.GetLength(0); y++)
            {
                ...
                {
                    camBufferNext[y, x] = wholeMap[y + camera.GetPos()[1] - Constants.CAMERA_RADIUS + 1, x + camera.GetPos()[0] - Constants.CAMERA_RADIUS + 1];
